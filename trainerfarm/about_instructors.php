		...
		<div class="content-block">
                        ...
                        <!-- <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-6 m-b30">
                                <div class="counter-style-1">
									...
									<span class="counter-text">Technologists For Life</span><br>
                                    <p>With hundreds signing up monthly in our platform</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-6 m-b30">
                                <div class="counter-style-1">
									...
									<span class="counter-text">University Bootcamp Alumni</span><br>
                                    <p>Driving their careers to the next level</p>
								</div>
                            </div>
                            <div class="col-lg-4 col-md-12 col-sm-12 col-12 m-b30">
                                <div class="counter-style-1">
									<div class="text-primary">
										<span class="counter">1500</span><span>+</span>
									</div>
									<span class="counter-text">Certifications & Learning Paths</span><br>
            ...
            <div class="mt-5">
                ...
                <div class="container text-center">
                    ...
                    <a href="#" class="btn explore"><b>Become an University Partner</b></a>
                </div>
            </div>
