                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 instructor-div">
                        <div class="">
                            ...
                            <br>
                            <h5 class="text-light">
                                TrainerFarm's team is a diverse group of talented individuals who share a common goal: to work together to achieve excellence. We are a dedicated group of professionals who bring a wealth of experience and expertise to every project we undertake.
                            </h5>
                            <br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx left">
                            <h2 class="title-head">Our <span style="color: var(--orange-primary)"> IT Instructors </span> Are Professionally Experienced</h2>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="card-container">
                                    <div class="profile-shape">
                                        <div class="profile-image" style="background-image: url('assets/images/instructors/ins1.png');"></div>
                                    </div>
                ...
                <div class="container">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="modal-title" id="myModalLabel">Become an Instructor</h2>
