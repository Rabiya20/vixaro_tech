                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx left">
                            <h2 class="title-head">Our <span style="color: var(--orange-primary)"> IT Instructors </span> Are Professionally Experienced In The Following Areas</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="card-body ">
                                <div class=" card-container">
                                    ...
                                    <h3 class="profile-title">Web Designer</h3>
