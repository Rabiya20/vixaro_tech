...
<div class="page-content">
    <div class="page-banner ">
        <div class="mt-4" style="background-image: url('https://gratisography.com/wp-content/uploads/2019/09/gratisography-rocky-cliff-view.jpg'); background-repeat: no-repeat; background-size: cover;">
            <div class="row">
                <div class="col-1"></div>
                <div class="col-4 p-5">
    ...
    <section class="portfolio-section" id="portfolio">
        ...
        <div class="portfolio-menu mt-2 mb-4">
            <nav class="controls">
                <button type="button" class="control outline" data-filter="all">All Stories</button>
                <button type="button" class="control outline" data-filter=".s_story">Student Stories</button>
                <button type="button" class="control outline" data-filter=".b_story">Business Stories</button>
                <button type="button" class="control outline" data-filter=".w_story">Written Stories</button>
            </nav>
        </div>
        <div class="container">
            <ul class="row portfolio-item">
                <li class="mix b_story col-xl-3 col-md-4 col-12 col-sm-6 pd">
                    ...
                    <div class="portfolio-overlay">
                        ...
                        <a href="#" title="View Project" target="_blank">
                            ...
                            <p><span><i class="fa fa-youtube" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
                        </div>
                    </div>
                </li>
                <li class="mix s_story col-xl-3 col-md-4 col-12 col-sm-6 pd">
                ...
                <li class="mix w_story col-xl-3 col-md-4 col-12 col-sm-6 pd">
                ...
                <div class="portfolio-overlay">
                    <div class="overlay-content">
                    <p class="category">Person Name</p>
                    <a href="#" title="View Project" target="_blank">
                        <div class="magnify-icon">
                        <p><span><i class="fa fa-youtube" aria-hidden="true"></i></span></p>
                        </div>
    ...
    <div class="section-area section-sp2" style="background-image: url('https://png.pngtree.com/thumb_back/fh260/back_our/20190621/ourmid/pngtree-learn-to-crash-course-cartoon-green-background-image_187785.jpg'); background-repeat: no-repeat; background-size: cover;">
        <div class="container" style="height: auto">
            ...
            <div class="section-area">
                <div class="container">
                    <div class="row">
                        <div class="col-6"></div>
                        <div class="col-6" style="background-color: var(--white-primary); padding: 20px; border-radius: 20px">
                            <div class="heading-bx left">
                                <h2 class="title-head">The Success of Trainerfarm Depends On The Success Of You.</h2>
                            </div>
                            <p>Trainerfarm students are the core value and lifeline of our business. Without you, we wouldn't be here. Hearing about your success drives our commitment, innovation, and allows us to deliver "best-in-class" IT training.</p>
                            <br>
                            <a href="" class="btn btn-primary"><b>Submit Your Success Story</b></a>
                        </div>
                    </div>
                </div>
                <br><br><br><br><br>
