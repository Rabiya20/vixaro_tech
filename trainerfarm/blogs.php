                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-5 sticky-top">
                        <aside class="side-bar sticky-top">
                                    ...
                                    <form role="search" method="post">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="submit" class="fa fa-search text-white" style="background-color: var(--orange-primary);"></button>
                                            </span>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="">
                                <h6 class="">Explore Out Bootcamp Program</h6>
                                <div class="">
                                    <form role="search" method="post" class="mb-3">
                                        <input name="fname" class="form-control" placeholder="First name" type="text"><br>
                                        <input name="lname" class="form-control" placeholder="Last name" type="text"><br>
                                        <input name="email" class="form-control" placeholder="Email" type="email"><br>
                                        <div class="text-dark mb-2 course-dropdown">
                                            <select class="header-lang-bx" name="course" id="course">
                                                <option value="">Select Interest Area</option>
                                                <option value="1">Cyber Security</option>
                                                <option value="2">Cloud Coumputing</option>
                                ...
                                <div class="news-box">
                                    ...
                                    <form class="subscription-form"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button name="submit" value="Submit" type="submit" class="btn btn-primary radius-no"><i class="fa fa-paper-plane-o"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
