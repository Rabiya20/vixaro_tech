...
<div class="page-content">
    <!-- Page Heading Box ==== -->
    <div class="page-banner ovbl-dark" style="background-image:url(assets/images/courses/course-axelos.jpg);">
        <div class="container mt-5">
            <div class="page-banner-entry">
                <h1 class="text-light">TrainerFarm's Axelos Certification</h1>
                <br>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-block mt-5 mb-5">
            ...
            <p>AXELOS certifications are globally recognized and are designed to provide individuals with the skills and knowledge needed to excel in their careers. The certifications are based on best practice guidance developed by industry experts and are regularly updated to ensure they remain relevant and up-to-date with the latest industry trends and technologies.</p>

            <p>In summary, AXELOS is a joint venture company that specializes in providing best practice guidance, certifications, and training in IT Service Management, Project Management, and Cyber Resilience. The company is best known for its flagship products, ITIL and PRINCE2, which are widely recognized as global standards for ITSM and project management, respectively. AXELOS certifications are designed to provide individuals with the skills and knowledge needed to succeed in their careers and are recognized globally by employers and industry professionals.</p>

            
            <h2 class="text-primary">Axelos certification offered by TrainerFarm:</h2>
            <ul>
                <li><a class="link" href="certificate-itil.php">ITIL&reg; 4 Foundations Certification</a></li>
            </ul>
        </div>
    </div>
</div>
