				...
				<ul>
					...
					data-description="Science says that Women are generally happier">
						...
						<div class="tp-caption tp-shape tp-shapewrapper " 
							...
							style="z-index: 5;background-color:rgba(2, 0, 11, 0.70);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>	
						<!-- LAYER NR. 2 -->
						<div class="tp-caption Newspaper-Title   tp-resizeme" 
							...
							style="z-index: 6; text-align:center; white-space: normal;">
								...
								<!-- <div>
									...
									<h4 style="color: #fff !important;">For 5 years, TrainerFarm has associated with IT experts and hiring managers to develop industry-aligned certificate courses and bootcamp training programs.</h4><br>
								</div> -->
						...
						<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								data-paddingbottom="[12,12,12,12]"
								data-paddingleft="[30,35,35,15]"
								style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									<h2 style="color: #fff !important;">TRAINING FOR BETTERMENT</h2>
									<h4 style="color: #fff !important; font-size: 15px !important; font-weight: 300 !important;">For 5 years, TrainerFarm has associated with IT experts and hiring managers to develop industry-aligned certificate courses and bootcamp training programs.</h4><br>
							</div>
					</li>
				</ul>
			</div>
